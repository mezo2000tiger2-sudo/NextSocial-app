...
useEffect(() => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 max-w-2xl mx-auto overflow-hidden w-full">
      ...
      <div className="flex items-center justify-between px-0.5 sm:px-4 py-2 text-slate-500 text-sm border-b border-slate-100">
      ...
      <div className="flex items-center border-b border-slate-100">
        <button
          onClick={handleLike }
          className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-medium transition hover:bg-slate-50 ${liked ? "text-blue-500" : "text-slate-600"}`}
        >
